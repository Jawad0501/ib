...
<div class="modal fade" id="log-out-confirm-modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-{{ $size}}">
        <div class="modal-content py-5">
            <div class="modal-header" style="border: none">
                <div class="title text-center w-100">
                    <h5 class="heading">User Logout</h5>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center align-items-center w-50 mx-auto">
                ...
                <button class="btn w-100 me-3 mt-3 py-2 border" type="button" onclick="document.getElementById('logout-form').submit();">Yes</button>
