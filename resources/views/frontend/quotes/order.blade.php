<x-frontend.modal :title="$quote->order_title" size="xl" button="Place Order" action="{{ route('quote.store') }}">
                    ...
                    <div class="row gy-4 gy-lg-0 align-items-center">
                        <div class="col-12 col-lg-5">
                            <div class="d-flex align-items-center">
                                <div class="me-2">
                                    <input class="form-check-input" type="checkbox" name="items[]" value="{{ $item->id }}" id="items[{{ $item->id }}]">
                                </div>
                                <div>
