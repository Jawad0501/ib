<aside class="right-bar bg-white">
    ...
    <div class="right-bar-footer d-none d-xl-flex flex-column align-items-center" style="padding-left: 30px">
        <div class="row gy-4 mt-2">
            <a href="{{route('order-quote', [encrypt($quote->id), 1, 'order'])}}" id="editBtn" class="w-100" style="all:unset">
                <div class="button">
                        <span>Re-Order</span>
                </div>
            </a>
...
<style>
    ...
    .order-right-bar-header .search-bar{
    ...
    .right-bar .order-right-bar-header {
        padding: 20px 0px;
        width: 100%;
    }
