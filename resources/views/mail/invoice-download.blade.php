...
<body style="color: #495057;">
    ...
    @php
        ...
        foreach($items as $item){
            $subtotal = $subtotal + (($item->unit_price * $item->quantity) + $item->setup_price);
                ...
                <div style="position: relative;">
                            ...
                            <div>
                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    @if($quote->order_number != null)
                                        <div style="font-size: 9px; font-weight: 500">{{$quote->order_number}}</div>
                                    @endif
                                </div>
                    ...
                    <div style="position: absolute; right:0; left: 27%; top:20%;">
                        ...
                        <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                            ...
                            <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px;margin-top: 10px; ">{{convertAmount($quote->total_discount)}}</div>
                        </div>
                        <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                            ...
                            <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount($quote->shipping_amount)}}</div>
                        </div>
                        <div  style="position: relative; width:270px; margin-left:auto;; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                            ...
                            <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount($quote->items->sum('vat_amount'))}}</div>
                        </div>
                        <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                            ...
                            <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount(($total + $quote->shipping_amount))}}</div>
                        </div>
                        <div  style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
