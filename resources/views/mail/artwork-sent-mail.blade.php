...
Your screen does a pretty bad impression of printed paper, so don't rely on the colours you see - they'll print differently. RGB and Pantone colours are converted to CMYK (where applicable), which will result in some colour shifts. You can request an artwork if you would like to check the CMYK colour makeup after pre-flighting.


<a href="{{route('placeorder.index', [encrypt($order->invoice), 'artwork'])}}" style="all:unset; font-weight:600; color: #000000; text-decoration:none; font-size: 16px; cursor: pointer; text-transform: uppercase" >
See Artwork
</a>
<br>
<br>
