...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center"  style=" width: 100%; max-width: 800px; margin: auto; margin-bottom: 40px">
            <div class="w-100">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4"  style=" width: 100%; max-width: 800px; margin: auto;  margin-bottom: 40px">
            <div>
        ...
        <div style="max-width: 800px; width: 100%; margin: auto; position: relative">
            <div class="d-flex">
                <div>
                    <div style="background-color:#9E9E9E; width: 240px; padding: 5px 0px; text-transform: uppercase; color: white; text-align: center">
                        Invoice To
                    </div>

                    <div class=""  style="background-color:#f2f2f3; width:240px; padding-left: 77px; padding-top: 20px; padding-bottom:20px">
                        <div>
                            <div>
                                <div style="font-size: 10px; font-weight: 600;  color: gray; margin-bottom: 10px">{{$quote->user?->name}}</div>
                            ...
                            <div style="margin-top: 20px">
                                ...
                                @if($quote->order_number != null)
                                    <div style="font-size: 10px; font-weight: 500">{{$quote->order_number}}</div>
                                @endif
                            </div>
                ...
                <div>
                                ...
                                @foreach($quote->items as $item)
                                    <tr>
                                        ...
                                        <td style="width: 118px; text-align:center; font-size: 11px; font-weight: 500; border-bottom: 2px solid #f2f2f3">
                                            {{ convertAmount($item->unit_price) }}
                                        </td>
                                        <td style="width: 118px; text-align:center; font-size: 11px; font-weight: 500; border-bottom: 2px solid #f2f2f3">
                                            {{ convertAmount($item->subtotal) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Sub Total</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount($subtotal) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Discount</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount($quote->total_discount) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Shipping</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount($quote->shipping_amount) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">VAT</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount($quote->items->sum('vat_amount')) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Grand Total</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount(($total)) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Paid Till Date</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount($quote->paid_amount) }}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px">Due</div>
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{ convertAmount(($total - $quote->paid_amount)) }}</div>
                    </div>
                </div>
            </div>
        </div>
