...
<body>
    <div class="container">
        ...
        <div style="max-width: 800px; width: 100%; margin: auto; position: relative">
            <div class="d-flex">
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        ...
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{convertAmount(0)}}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                    ...
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
                        ...
                        <div style="color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 13px">{{convertAmount(20)}}</div>
                    </div>
                    <div class="d-flex justify-content-between" style="width:185px; margin-left:auto; border-bottom:  2px solid #f2f2f3; padding: 10px 0px">
            ...
            {{-- <div style="text-transform: uppercase; text-align:end; font-size: 25px; font-weight: 600; color: black; position: absolute; bottom: 0; right: 0;">
                <div>Thank you</div>
