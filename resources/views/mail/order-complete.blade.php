...
Your order has been completed and is ready for collection. <br>

<a href="{{route('placeorder.index', [encrypt($order->invoice), 'completed'])}}" style="all:unset; font-weight:600; color: #005EFF; font-size: 16px; cursor: pointer; text-decoration: none" >
    See Status
</a>
