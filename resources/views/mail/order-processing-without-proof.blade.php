...
Your order is now being processed. Please be patient for further notice. <br>

<a href="{{route('placeorder.index', [encrypt($order->invoice), 'processing'])}}" style="all:unset; font-weight:600; color: #005EFF; font-size: 16px; cursor: pointer; text-decoration: none" >
    See Status
</a>
