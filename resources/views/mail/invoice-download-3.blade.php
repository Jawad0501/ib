...
<body style="color: #495057;">
    <div class="container" style="height: 1000px">
        ...
        <div  style="position: relative; width: 100%; max-width: 800px; margin: auto;">
            ...
            <div style="position: absolute; right: 50; text-align: right; margin-top: 50px">
            ...
            <div style="">
                <div style="position: absolute; left:0; top:20%">
                    ...
                    <div class=""  style="background-color:#f2f2f3; width:130px; padding-left: 57px; padding-right:20px; padding-top: 20px; padding-bottom:20px">
                        <div>
                            <div>
                                <div style="font-size: 9px; font-weight: 600;  color: gray;">{{$quote->user?->name}}</div>
                                <div class="text-uppercase" style="color:black; font-weight:600; font-size:10px">{{$quote->user?->company_name}}</div>
                            </div>

                            <div style="margin-top: 10px;">
                                @if($quote->user?->delivery_address != null)
                                    <div style="font-size: 9px; font-weight: 500">{{$quote->user?->delivery_address->address_line_1}}, {{$quote->user?->delivery_address->address_line_2}}</div>
                            ...
                            <div style="margin-top: 10px;">
                                ...
                                @if($quote->user?->delivery_address != null)
                                    <div style="font-size: 9px; font-weight: 500">{{$quote->user?->delivery_address->postcode}}</div>
                                @endif
                            </div>
                            ...
                            <div style="margin-top: 10px;">
                                ...
                                <div style="font-size: 9px; font-weight: 500; margin-top: 10px; margin-bottom: 10px;">Terms: {{$quote->account_type}}</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-uppercase" style="font-size: 12px; font-weight: 600; color: black; margin-bottom: 10px">
                                <div>This is not</div>
                                <div>a tax invoice</div>
                            </div>
                ...
                <div style="position: absolute; right:0; left: 27%; top:20%;">
                    ...
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px;">
                        ...
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px;  margin-top: 5px;">{{convertAmount($subtotal)}}</div>
                    </div>
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                        ...
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px;margin-top: 10px; ">{{convertAmount(0)}}</div>
                    </div>
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                    ...
                    <div  style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                        <div style="position: absolute; left:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px; margin-top: 10px;">VAT</div>
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount(20)}}</div>
                    </div>
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                        ...
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount($total)}}</div>
                    </div>
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                        <div style="position: absolute; left:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px; margin-top: 10px;">Paid Till Date</div>
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount($quote->paid_amount)}}</div>
                    </div>
                    <div style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                        <div style="position: absolute; left:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-left: 13px; margin-top: 10px;">Due</div>
                        <div style="position: absolute; right:0; color: black; font-weight: 600; font-size: 11px; text-transform: uppercase; padding-right: 30px; margin-top: 10px;">{{convertAmount(($total - $quote->paid_amount))}}</div>
                    </div>
                    <div  style="position: relative; width:270px; margin-left:auto; margin-bottom: 20px; border-bottom:  2px solid #f2f2f3; padding: 5px 0px">
                ...
                <div style="text-transform: uppercase; position: absolute; bottom: 0; right: 0; text-align:right; font-size: 25px; font-weight: 600; color: black">
                    <div>Thank you</div>
